...
function cardFromDB(dbObj){
    return new Card(dbObj.crd_id, dbObj.crd_name, dbObj.crd_url, dbObj.crd_lore, dbObj.crd_description, dbObj.crd_level, dbObj.cr_cost, dbObj.crd_timeout, dbObj.crd_max_usage, dbObj.crd_type);
}
